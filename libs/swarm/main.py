...
from models import BaseChatCompletions as ChatCompletions, OPENROUTER_MODELS
...
while True:
    ...
    response: ChatCompletion = client.chat.completions.create(**args.model_dump())

    logger.info(response)

    console = Console()

    assistant_message = Markdown(response.choices[0].message.content.strip())
    console.print("\nAssistant: ", "\n\n", assistant_message)
